...
#### (차세대 반도체 디지털 혁신공유대학:서울대학교) 중급 프로젝트
- 학수번호: (M3502.001500)SNUM3502.015
- 교수: 이우빈 교수님
- 수업
    - 아두이노로 미디 건반 컨트롤러 만듭니다.
    - 쉽게 설명해주셔서 초보자도 잘 할듯 하네요.
- 과제
    - 중간에 한 번씩 미니 프로젝트처럼 어떤 주제를 주시고, 이에 대한 구현과 코드를 같이 제출합니다.
    - 금방 할만한 내용들이라 좋았어요.
- 시험
    - 없습니다. 미디 건반 컨트롤러 완성하는게 시험 대체입니다.

#### (차세대 반도체 디지털 혁신공유대학:서울대학교) 인공지능 하드웨어 설계 프로젝트
- 학수번호: (M3500.001500)SNUM3500.015
- 교수: Xuan-Truong Nguyen 교수님
- 수업
    - RISC-V 기반 NPU 만듭니다.
    - Super Resolution을 위한 CNN Accelerator 만듭니다.
    - 아키적인 내용이 많이 섞여있지만 재밌어서 잘 들었습니다.
    - 솔직히 난이도는 좀 있는거 같긴 해요(아키 안 듣고 들어서 그런거 같기도?)
    - 다만 하이브리드이지만 교수님이 비대면 학생 위주로 신경을 쓰셔서 조금 아쉽긴 합니다.
- 과제
    - 매주 베릴로그로 배운 부분을 구현합니다.
    - 스켈레톤 코드 위에 짜는거라 그렇게까지는 어렵지는 않습니다.
- 시험
    - 기말 한 번 봅니다.
    - 대면으로 시험보러 가면 되는데 시험 내용은 의외로 좀 디테일한 내용을 물어봐서 준비를 대충하면 힘들 듯?
